...
imageData = open("D:\\post_CHESS_data\\set-08MAR2024-ringwalk-7pm\\run-scan_TD_100020\\frames\\scan_TD_100020_00000001.raw","rb")
...
def keckFrame(dataFile):
    ...
    print("cap number =", capNum)
    print("frame number =", frameNum)
    print("integTime =", integTime)
